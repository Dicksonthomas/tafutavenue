...
<body style="font-family: Arial, sans-serif; background:#f1f5f9; padding:24px;">
    <div style="max-width:480px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;">
        ...
        <div style="padding:24px;color:#1e293b;">
            ...
            <p>Akaunti yako ya Class Representative (CR) imetengenezwa. Tumia taarifa zifuatazo kuingia kwenye mfumo:</p>
            ...
            <table style="width:100%;border-collapse:collapse;margin:16px 0;">
                ...
                <tr>
                    <td style="padding:8px 0;color:#64748b;font-size:13px;">Password ya Muda</td>
            ...
            <p style="font-size:13px;color:#64748b;">
                Kwa usalama wako, tunakushauri ubadilishe password hii mara tu utakapoingia
                (Profile &rarr; Badilisha Password).
            </p>
        </div>
    </div>
</body>
